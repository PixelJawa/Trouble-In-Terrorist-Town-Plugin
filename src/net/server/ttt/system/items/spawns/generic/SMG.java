...
public class SMG extends TTTItemWeaponShootable {
    ...
    static double damage = 0.6;
    static double headMultiplier = 1.2;
    static double fireRate = 24; // shots per second
    static String weaponName = ChatColor.LIGHT_PURPLE + "SMG";
    static boolean isHoldable = true;

    static double reloadTime = 3.5;
    static int magSize = 38;
    static double range = 200;
    static double accuracy = 0.75;

    static WeaponType weaponType = WeaponType.PRIMARY;
    static int ammoBatchAmount = 24;
    static String weaponId = "ttt_item_weapon_smg";
    static String ammoId = "ttt_item_ammo_smg";

    // weapon
    static ItemStack weapon = new ItemStack(Material.GOLDEN_PICKAXE, 1);
    static {
        ...
        lore.add(ChatColor.GRAY + "A shot range weapon with an extremely high fire rate.");
    ...
    // ammo
    static ItemStack ammo = new ItemStack(Material.NETHER_WART, ammoBatchAmount);
    static {
        ArrayList<String> lore = new ArrayList<>();
        ItemMeta meta = ammo.getItemMeta();

        meta.setDisplayName(ChatColor.DARK_GRAY + "SMG Ammo");
    ...
    public void shoot(Player player) {
        ...
        Item item = world.dropItem(loc, new ItemStack(Material.BIRCH_BUTTON));
    ...
    public void shotParticles(Location loc) {
        ...
        world.spawnParticle(Particle.REDSTONE, loc, 1, 0, 0, 0, 0, new Particle.DustOptions(Color.NAVY, 0.5f), true);
    }
